...
def load_chain():
    ...
    table_schema_objs = []
    for table in tables:
        table_schema_objs.append((SQLTableSchema(table_name = table, context_str = st.session_state.get('tables_dict')[table])))
...
if __name__ == "__main__":
    ...
    if not st.session_state.get("open_api_key_configured")  or not st.session_state.get("database_configured"):
